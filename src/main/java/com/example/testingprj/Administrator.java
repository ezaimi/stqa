...
//    }
	...
	public static Manager getBackManager(Manager mag,ArrayList<Manager>managers) {
...
//    	return null;
	...
	public static void deleteManager(Manager mag,ArrayList<Manager>managers) {
//    	for (int i=0;i<managers.size();i++) {
//    		if (managers.get(i).getUsername().equals(mag.getUsername()) ) {
//    			managers.remove(i);
//    			return;
...
//    	}
	...
	public static void updateManagers(Manager mag,ArrayList<Manager>managers) {
